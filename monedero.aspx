<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeFile="monedero.aspx.cs" Inherits="MasTicket.monedero" %>
<!DOCTYPE html>
        ...
        <section class="container top-no-header">
            <div class="row">
                    <div class="col-md-9"><div class="white-row">
                            <h2><i class="fa fa-briefcase"></i> <strong>Monedero</strong></h2>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:35%;">Saldo a recargar: $<asp:TextBox runat="server" ID="txtMonto" style="width:100px;" /> </td>
                ...
                <div class="col-md-3">
                        <div class="white-row">
								<p>El monedero es dinero virtual, con el cual despues puede hacer recargas. Puede obtener dinero virtual por medio de promociones o mediante recargas directas con tarjeta.</p>
                                <p>Para recargar con tarjeta, capture el monto en pesos a recargar y seleccione alguna tarjeta, o captura una nueva.</p>
                                <figure>
                                    <a class="img-thumbnail lightbox" href="assets/images/mone1.jpg" data-plugin-options='{"type":"image"}'>
                                    <img src="assets/images/mone1.jpg" class="img-responsive thumbnail zoom" alt="img" />
                                    </a>
                                </figure>
                        </div>
                    </div>
