                ...
                if (colIndex == 0)
                {
                    if (tiporeporte == "C")
                    {
                        ...
                        if (exportData.Rows[rowIndex][0] is DBNull)
                            ...
                            {
                                case "0":
                                    backg.FillForegroundColor = IndexedColors.BRIGHT_GREEN.Index;
                                    codigo = "OK";
                                    break;
                                case "1":
                                    backg.FillForegroundColor = IndexedColors.BLUE.Index;
                                    codigo = "AVM";
                                    break;
                                case "2":
                                    backg.FillForegroundColor = IndexedColors.RED.Index;
                                    codigo = "RV";
                                    break;
                                case "-1":
                                case "3":
