<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valida_codigo_d.aspx.cs" Debug="true" Async="true" Inherits="MasTicket.registro" %>
<!DOCTYPE html>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form id="frmAlta" runat="server">
                            <h2><strong>Validar cuenta</strong></h2>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Revisa tu teléfono celular, te debió haber llegado un código por medio de un mensaje SMS, ingresalo en esta página para finalizar tu registro:</p>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input runat="server" id="txtCodigo" type="number" required minlength="10" maxlength="10" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Button runat="server" data-loading-text="Validando..." id="btnRegistrar" Text="Validar" class="btn btn-primary pull-right push-bottom" />
                                </div>
                            </div>
<!--
                            <div class="row">
                                <div class="col-md-6 text-center">
                                    ...
                                    <p><asp:Button runat="server" data-loading-text="Reenviando..." id="btnReenviar" Text="Re enviar" class="btn btn-secondary push-bottom" /></p>
                                     <asp:Label ID="tiempo" runat="server" Visible="false" Text="Hello World!" />
                                </div>                    
                            </div>
-->
                        </form>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="white-row">
                            <h4><strong>Revisa tu teléfono celular</strong></h4>
            ...
            $('#frmAlta').validate({
                ...
                messages: {
                    txtCodigo: {
                        ...
                        number: "Código con caracteres no validos",
                        minlength: "Código de 10 digitos",
                        maxlength: "Código de 10 digitos",
                    },                    
                },
