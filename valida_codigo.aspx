<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valida_codigo.aspx.cs" Debug="true" Async="true" Inherits="MasTicket.registro" %>
<!DOCTYPE html>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input runat="server" id="txtCodigo" type="number" required minlength="6" maxlength="6" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
            ...
            $('#frmAlta').validate({
                ...
                messages: {
                    txtCodigo: {
                        ...
                        minlength: "Código de 6 digitos",
                        maxlength: "Código de 6 digitos",
                    },                    
                },
