<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="MasTicket.login" %>
<!DOCTYPE html>
        ...
        <div id="wrapper" style="background:rgba(0,0,0,0.2);">
            ...
            <section class="container top-no-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-row">
                            <h2><strong>¿Olvidaste tu Password?</strong></h2>

                            <p>
                                Captura tu email y te enviaremos una nueva contraseña
                            </p>
                            ...
                            <!-- password form -->
                            <label>Capture su E-mail</label>
                            <!--<form class="input-group" method="post"  role="form"  action="send_mail.aspx">-->                                
                                <input runat="server" type="text" class="form-control" name="edtCorreo" id="edtCorreo" value="" placeholder="E-mail" />
                                <span class="input-group-btn">
                                    <asp:Button runat="server" CssClass="btn btn-primary" id="btnEnviaCorreo" Text="Enviar"/>
                                </span>
                            <!--</form>-->
