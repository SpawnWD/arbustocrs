<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Async="true" CodeFile="conciliacion_admin.aspx.cs" Inherits="MasTicket.conciliacion_admin" %>
<!DOCTYPE html>
...
<!------------------------------------------------------------------------------------------------------------>
        ...
        <section class="container top-no-header">
            <div class="row">
                    <div class="col-md-12">
                        <div class="white-row">
                            <h2><i class="fa fa-clock-o"></i> <strong>Reporte de conciliación</strong></h2>
                                <div class="container">
                                    <div class="row">
