<%@ Page Language="C#" EnableEventValidation="false" Async="true" AutoEventWireup="true" CodeFile="nuevatarjeta.aspx.cs" Inherits="MasTicket.nuevatarjeta" %>
<!DOCTYPE html>
                    ...
                    <div class="col-md-9"><div class="white-row">
                        <h2><i class="fa fa-credit-card"></i> <strong>Nueva Tarjeta</strong></h2>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="card_number" data-openpay-card="card_number">
                                <input runat="server" type="hidden" id="deviceIdHiddenFieldName" />
                                <input runat="server" type="hidden" id="token_id" />
                            </div>
                            <div class="form-group">
                                <label for="numero" class="control-label col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-2">
                                    <input runat="server" data-openpay-card="expiration_month" id="mes" name="mes" placeholder="Mes" required maxlength="2" minlength="2" type="number" value="" class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <input runat="server" data-openpay-card="expiration_year" id="anio" name="anio" placeholder="Año" required maxlength="2" minlength="2" type="number" value="" class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <input runat="server" data-openpay-card="cvv2" id="cvc" name="cvc" placeholder="CVC" required maxlength="4" minlength="4" type="number" value="" class="form-control">
                                </div>
                            </div>
                            <!------ Datos del Titular --------->
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-6">
                                    <input runat="server" data-openpay-card="holder_name" id="nombre" name="nombre" placeholder="Nombre(s)" class="date-picker form-control col-md-12 col-xs-12" required="required" type="text">
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <!--<asp:Button runat="server" OnClientClick="return(false);" id="btnCancelar" Text="Cancelar" class="btn btn-primary" />&nbsp;&nbsp;&nbsp;-->
                                <asp:Button runat="server" id="btnGuardar" Text="Guardar" class="btn btn-primary pull-right push-bottom" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
...
<!------------------------------------------------------------------------------------------------------------>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var deviceSessionId = OpenPay.deviceData.setup("frmnuevatarjeta");
                ...
                $('#btnGuardar').on('click', function (event) {
                    ...
                    Cargando();
                    OpenPay.token.extractFormAndCreate('frmnuevatarjeta', success_callback, error_callback);
                });

                var success_callback = function (response) {
                    var token_id = response.data.id;
                    $('#token_id').val(token_id);
                    //$('#frmnuevatarjeta').submit();
        ...
        <script>
            if ($("#txtNum1").val().length > 0 && $("#txtNum2").val().length > 0 && $("#txtNum3").val().length > 0 && $("#txtNum4").val().length > 0) {
                var cnum = $("#txtNum1").val() + $("#txtNum2").val() + $("#txtNum3").val() + $("#txtNum4").val();
                $("#card_number").val(cnum);
                $("#mes").focus();
            }
            else
                $("#txtNum1").focus();
