<%@ Page Language="C#" EnableEventValidation="false" Async="true" AutoEventWireup="true" CodeFile="confir_monedero.aspx.cs" Inherits="MasTicket.confir_monedero" %>
<!DOCTYPE html>
...
<!------------------------------------------------------------------------------------------------------------>
        <div id="wrapper" style="background:rgba(0,0,0,0.2);">
            ...
            <div class="row">
                <div class="col-md-9">
                <div class="white-row" >
                        <h2><i class="fa fa-briefcase"></i> <strong>Recargar monedero</strong></h2>
                        ...
                        <div class="form-group">
                            ...
                            <p align="right">
                                ...
                                &nbsp;&nbsp;
                                <a href="#" id="btnNIP" data-mfp-src="#divNIP" class="open-popup-link btn btn-success">¡ Recargar Ahora !</a>
                            </p>
                        </div>        
                        </div>
                </div>
