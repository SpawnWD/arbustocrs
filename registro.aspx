                    ...
                    <div class="col-md-6">
                        ...
                        <form id="frmAlta" runat="server">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>Confirmar número de teléfono móvil</label>
...
<!------------------------------------------------------------------------------------------------------------>
        ...
        <script type="text/javascript" src="assets/js/feisV2.js"></script>
        <script>
            IniciarFeis();
        </script>
        <script type="text/javascript" src="assets/js/gugleV2.js"></script>
        <script>
            startApp();
        </script>
                ...
                rules: {
                    txtNombre: {
                      ...
                      // regex: /^[a-zA-Z_áéíóúñ\s]*$/,
                        //  regex: /([a-zA-Z]?[aeiou]+[a-zA-Z]?)*/,
                    //    regex: /^([a-zA-Z]?[aeiou]+[a-zA-Z]+[a-zA-Z]\s?)*$/,
