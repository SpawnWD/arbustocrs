<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeFile="histrecprog.aspx.cs" Inherits="MasTicket.histrecprog" %>
<!DOCTYPE html>
...
<!------------------------------------------------------------------------------------------------------------>
        ...
        <section class="container top-no-header">
            <div class="row">
                    <div class="col-md-9">
                        <div class="white-row">
                            <h2><i class="fa fa-clock-o"></i> <strong>Recargas Programadas</strong></h2>
