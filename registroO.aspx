                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form id="frmAlta" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Button runat="server" data-loading-text="Guardando..." OnClientClick="ValidateLogin();" id="btnRegistrar" Text="Registrate" class="btn btn-primary pull-right push-bottom" />
                                </div>
                            </div>
